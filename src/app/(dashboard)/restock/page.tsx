    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Critical replenishment monitoring. Items stay here until stock is
            restored.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="bg-card rounded-2xl border p-6 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="rounded bg-red-100 p-3 text-red-600 dark:bg-red-900/20">
        ...
        <div className="bg-card rounded-2xl border p-6 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="rounded bg-orange-100 p-3 text-orange-600 dark:bg-orange-900/20">
                  ...
                  <TableRow key={item._id} className="group transition-colors">
                    ...
                    <TableCell className="text-right">
                      <Button
                        ...
                        className="h-9 rounded bg-blue-600 text-xs font-bold hover:bg-blue-700"
                      >
        ...
        <DialogContent className="rounded-2xl sm:max-w-md">
          ...
          {selectedItem && (
            <div className="space-y-4 py-4">
              <div className="flex items-center gap-4 rounded bg-blue-50 p-4 dark:bg-blue-900/20">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-[10px]">
                  ...
                  {selectedItem.currentStock + addedStock}
                </p>
              </div>
            </div>
          )}
